...
/*
 * The Collection "Link" metabox is registered with the native fields
 * framework in includes/class-wp-mylinks-metaboxes.php (1.1.0) — the old
 * register_meta_box_cb / cmb2_admin_init wiring is gone with CMB2.
 */
